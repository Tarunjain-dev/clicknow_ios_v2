...
class CustomerBookingStatusScreen extends StatefulWidget {
  ...
  @override
  State<CustomerBookingStatusScreen> createState() => _CustomerBookingStatusScreenState();
}

class _CustomerBookingStatusScreenState extends State<CustomerBookingStatusScreen> {
          ...
          child: uid == null
              ...
              : StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final canReschedule = const <String>{
                      'REQUESTED',
                      'APPROVED',
                      'ASSIGNED',
                      'CONFIRMED',
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  if (canShowOtp) ...[
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontSize: scale.getScaledFont(28),
                                        letterSpacing: 8,
                                      ),
                                    ),
                                    SizedBox(height: scale.getScaledHeight(4)),
                          ...
                          SizedBox(height: scale.getScaledHeight(11)),
                          if (canPayRemaining)
                            SizedBox(
      ...
      await Navigator.of(context).push(
        MaterialPageRoute<void>(
          builder: (_) => RaiseTicketScreen(
            ...
            initialSubject:
                'Issue with booking ${_firstNonEmpty([
              _string(bookingData['bookingCode']),
              widget.bookingCode,
              widget.bookingId,
            ])}',
  ...
  Widget _timelineCard({
    ...
    final finalStatusLabel = statusCode == 'REJECTED'
        ? 'REJECTED'
        : 'CANCELLED';
    final finalStatusMessage = statusCode == 'REJECTED' ? 'Rejected by admin' : cancelledByRole == 'admin' ? 'Canceled by admin' : 'Canceled by customer';
      ...
      Column(
        ...
        children: [
          ...
          ...List.generate(steps.length, (index) {
            ...
            final subtitle = finalStatusLabel == 'REJECTED' ? "Rejected" : done ? 'Completed' : active ? (number == 2 ? 'In Progress (1 - 24 Hrs.)' : 'In Progress') : 'Pending';
  ...
  Future<void> _requestReschedule(DateTime? currentDate) async {
    final uid = _auth.currentUser?.uid;
    ...
    if (reason.isEmpty) {
      AppSnackbar.error(
        'Reason Required',
        'Please enter a reason for reschedule request.',
      );
      return;
    }
    ...
    try {
      ...
      AppSnackbar.success(
        'Rescheduled',
        'Booking has been moved and lifecycle reset successfully.',
      );
    } catch (_) {
      AppSnackbar.error(
        'Request Failed',
