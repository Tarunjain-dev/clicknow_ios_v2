...
class ProfessionalAnchorServicesScreen extends StatelessWidget {
  const ProfessionalAnchorServicesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const CustomerServiceDetailScreen(
      config: CustomerServiceDetailConfigs.anchor,
    );
  }
}
